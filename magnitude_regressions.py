################################################################################
##  magnitude_regressions.py: Bayesian analysis examining whether the magnitude of N, irrigation, or drought treatments affect the richness or compositonal differences.
##
##  Author: Nate Lemoine

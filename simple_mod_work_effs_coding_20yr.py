################################################################################
##  simple_mod_work_effs_coding_20yr.py: Bayesian analysis examining differences in richness and composition for datasets cutoff at 20 years.
##
##  Author: Nate Lemoine
...
corre_data = pd.read_csv('/nfs/corre-data/ForAnalysis_allAnalysis20yr.csv')
...
meanFit = compMod.sampling(data=simple_data_1, iter=10000, chains=4, 
  sample_file='/nfs/corre-data/simple_mod_effs_coding_interactions_20yr')
################################################################################
##  magnitude_regressions_weaklyinf.py: Bayesian analysis with weakly informative priors examining whether the magnitude of N, irrigation, or drought treatments affect the richness or compositonal differences.
##
##  Author: Nate Lemoine

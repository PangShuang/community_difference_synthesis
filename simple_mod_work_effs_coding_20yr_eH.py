...
corre_data = pd.read_csv('/nfs/corre-data/ForAnalysis_allAnalysis20yr_expH_PC.csv')
...
meanFit = compMod.sampling(data=simple_data_1, iter=10000, chains=4, 
  sample_file='/nfs/corre-data/simple_mod_effs_coding_interactions_20yr_expH_PC')